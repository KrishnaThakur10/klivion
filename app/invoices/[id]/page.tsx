          ...
          >
            <div className="flex items-start justify-between gap-4 mb-6">
              <div className="min-w-0">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h1
                    className="text-[20px] md:text-[26px] font-bold tracking-tight"
            ...
            >
              <div className="overflow-x-auto">
                {/* Table header */}
                <div
                  className="grid px-4 py-2.5 text-[10px] font-semibold uppercase tracking-wider min-w-[400px]"
                  style={{
                ...
                {invoice.lineItems.map((item, i) => (
                  <div
                    key={item.id}
                    className="grid items-center px-4 py-3 min-w-[400px]"
                    style={{
                      gridTemplateColumns: "1fr 56px 96px 96px",
                      borderBottom:
